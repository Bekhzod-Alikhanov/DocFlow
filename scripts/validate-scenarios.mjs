...
execSync('npx vitest run src/lib/tabletop/scenarios/production-incident.test.ts src/lib/tabletop/scenarios/registry.test.ts src/lib/tabletop/schema.test.ts', { stdio: 'inherit' })
